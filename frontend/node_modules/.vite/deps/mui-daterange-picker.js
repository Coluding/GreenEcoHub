import {
  ...
  init_utils,
  utils_exports
} from "./chunk-P4ML3YR3.js";
import "./chunk-62MWPLVP.js";
import "./chunk-DX3EHHVH.js";
...
var chunks = (array, size) => Array.from({ length: Math.ceil(array.length / size) }, (_v, i2) => array.slice(i2 * size, i2 * size + size));
var getDaysInMonth2 = (date, locale2) => {
  const startWeek = startOfWeek(startOfMonth(date), { locale: locale2 });
  const endWeek = endOfWeek(endOfMonth(date), { locale: locale2 });
  const days = [];
...
var getDefaultRanges = (date, locale2) => [
  {
    label: "Today",
    startDate: date,
    endDate: date
  ...
  {
    label: "This Week",
    startDate: startOfWeek(date, { locale: locale2 }),
    endDate: endOfWeek(date, { locale: locale2 })
  },
  {
    label: "Last Week",
    startDate: startOfWeek(addWeeks(date, -1), { locale: locale2 }),
    endDate: endOfWeek(addWeeks(date, -1), { locale: locale2 })
  },
  {
    label: "Last 7 Days",
...
var generateYears = (relativeTo, count) => {
  ...
  return Array(count).fill(0).map((_y, i2) => relativeTo.getFullYear() - half + i2);
};
var Header = ({ date, setDate: setDate2, nextDisabled, prevDisabled, onClickNext, onClickPrevious, locale: locale2 }) => {
  const MONTHS = typeof locale2 !== "undefined" ? [...Array(12).keys()].map((d3) => {
    var _a;
    return (_a = locale2.localize) === null || _a === void 0 ? void 0 : _a.month(d3, { width: "abbreviated", context: "standalone" });
  }) : ["Jan", "Feb", "Mar", "Apr", "May", "June", "July", "Aug", "Sept", "Oct", "Nov", "Dec"];
  const handleMonthChange = (event) => {
    setDate2(setMonth(date, parseInt(event.target.value, 10)));
  };
  const handleYearChange = (event) => {
    setDate2(setYear(date, parseInt(event.target.value, 10)));
  };
...
var Month = (props) => {
  var _a;
  const { helpers, handlers, value: date, dateRange, marker, setValue: setDate2, minDate, maxDate, locale: locale2 } = props;
  const weekStartsOn = ((_a = locale2 === null || locale2 === void 0 ? void 0 : locale2.options) === null || _a === void 0 ? void 0 : _a.weekStartsOn) || 0;
  const WEEK_DAYS = typeof locale2 !== "undefined" ? [...Array(7).keys()].map((d3) => {
    var _a2;
    return (_a2 = locale2.localize) === null || _a2 === void 0 ? void 0 : _a2.day((d3 + weekStartsOn) % 7, { width: "short", context: "standalone" });
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement(
      Grid_default,
      { container: true },
      import_react.default.createElement(Header, { date, setDate: setDate2, nextDisabled: !forward, prevDisabled: !back, onClickPrevious: () => handlers.onMonthNavigate(marker, NavigationAction.Previous), onClickNext: () => handlers.onMonthNavigate(marker, NavigationAction.Next), locale: locale2 }),
      ...
      import_react.default.createElement(Grid_default, { item: true, container: true, direction: "column", justifyContent: "space-between", sx: {
        ...
        marginTop: "15px",
        marginBottom: "20px"
      } }, chunks(getDaysInMonth2(date, locale2), 7).map((week, idx) => import_react.default.createElement(Grid_default, { key: idx, container: true, direction: "row", justifyContent: "center" }, week.map((day) => {
...
var Menu = (props) => {
  const { ranges, dateRange, minDate, maxDate, firstMonth, setFirstMonth, secondMonth, setSecondMonth, setDateRange, helpers, handlers, locale: locale2 } = props;
      ...
      import_react.default.createElement(
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(
            ...
            import_react.default.createElement(Typography_default, { variant: "subtitle1" }, startDate ? format(startDate, "dd MMMM yyyy", { locale: locale2 }) : "Start Date")
          ),
          import_react.default.createElement(
            Grid_default,
            { item: true, sx: { flex: 1, textAlign: "center" } },
          ...
          import_react.default.createElement(
            Grid_default,
            { item: true, sx: { flex: 1, textAlign: "center" } },
            import_react.default.createElement(Typography_default, { variant: "subtitle1" }, endDate ? format(endDate, "dd MMMM yyyy", { locale: locale2 }) : "End Date")
          )
        ),
        ...
        import_react.default.createElement(
          ...
          import_react.default.createElement(Month, Object.assign({}, commonProps, { value: firstMonth, setValue: setFirstMonth, navState: [true, canNavigateCloser], marker: MARKERS.FIRST_MONTH, locale: locale2 })),
          import_react.default.createElement(Divider_default, { orientation: "vertical", flexItem: true }),
          import_react.default.createElement(Month, Object.assign({}, commonProps, { value: secondMonth, setValue: setSecondMonth, navState: [canNavigateCloser, true], marker: MARKERS.SECOND_MONTH, locale: locale2 }))
        )
      )
    )
  );
...
var DateRangePicker = (props) => {
  ...
  const { open, onChange, initialDateRange, minDate, maxDate, definedRanges = getDefaultRanges(/* @__PURE__ */ new Date(), props.locale), locale: locale2 } = props;
  ...
  return open ? React.createElement(Menu, { dateRange, minDate: minDateValid, maxDate: maxDateValid, ranges: definedRanges, firstMonth, secondMonth, setFirstMonth: setFirstMonthValidated, setSecondMonth: setSecondMonthValidated, setDateRange: setDateRangeValidated, helpers, handlers, locale: locale2 }) : null;
};
