...
true ? Popover.propTypes = {
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types16.default.oneOfType([HTMLElementType, import_prop_types16.default.instanceOf(React18.Component), import_prop_types16.default.func]),
  /**
...
function useControlled(_ref3) {
  ...
  var _React$useRef = React21.useRef(controlled !== void 0), isControlled = _React$useRef.current;
  var _React$useState = React21.useState(defaultProp), valueState = _React$useState[0], setValue = _React$useState[1];
  ...
  if (true) {
    ...
    var _React$useRef2 = React21.useRef(defaultProp), defaultValue = _React$useRef2.current;
    React21.useEffect(function() {
  ...
  var setValueIfUncontrolled = React21.useCallback(function(newValue) {
    if (!isControlled) {
      setValue(newValue);
    }
  }, []);
...
var SelectInput = React22.forwardRef(function SelectInput2(props, ref) {
  ...
  var _React$useState = React22.useState(null), displayNode = _React$useState[0], setDisplayNode = _React$useState[1];
  var _React$useRef = React22.useRef(openProp != null), isOpenControlled = _React$useRef.current;
  var _React$useState2 = React22.useState(), menuMinWidthState = _React$useState2[0], setMenuMinWidthState = _React$useState2[1];
  var _React$useState3 = React22.useState(false), openState = _React$useState3[0], setOpenState = _React$useState3[1];
  var handleRef = useForkRef(ref, inputRefProp);
  React22.useImperativeHandle(handleRef, function() {
    return {
  ...
  var childrenArray = React22.Children.toArray(children);
  var handleChange = function handleChange2(event) {
  ...
  return React22.createElement(React22.Fragment, null, React22.createElement("div", _extends({
  ...
  ) : display), React22.createElement("input", _extends({
    ...
    autoFocus
  }, other)), React22.createElement(IconComponent, {
  ...
  }), React22.createElement(Menu_default, _extends({
    id: "menu-".concat(name || ""),
...
var ArrowDropDown_default = createSvgIcon(React23.createElement("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
...
var NativeSelectInput = React24.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return React24.createElement(React24.Fragment, null, React24.createElement("select", _extends({
    className: clsx_m_default(
      classes.root,
      // TODO v5: merge root and select
      classes.select,
    ...
    disabled,
    ref: inputRef || ref
  }, other)), props.multiple ? null : React24.createElement(IconComponent, {
...
var defaultInput = React25.createElement(Input_default, null);
var NativeSelect = React25.forwardRef(function NativeSelect2(props, ref) {
  ...
  return React25.cloneElement(input, _extends({
...
var _ref = React26.createElement(Input_default, null);
var _ref2 = React26.createElement(FilledInput_default, null);
var Select = React26.forwardRef(function Select2(props, ref) {
  ...
  var InputComponent = input || {
    standard: _ref,
    outlined: React26.createElement(OutlinedInput_default, {
      label,
      labelWidth
    }),
    filled: _ref2
  }[variant];
  return React26.cloneElement(InputComponent, _extends({
...
var TextField = React27.forwardRef(function TextField2(props, ref) {
  ...
  if (variant === "outlined") {
    ...
    if (label) {
      ...
      InputMore.label = React27.createElement(React27.Fragment, null, label, displayRequired && " *");
    }
  }
  if (select) {
  ...
  var InputElement = React27.createElement(InputComponent, _extends({
  ...
  return React27.createElement(FormControl_default, _extends({
    className: clsx_m_default(classes.root, className),
    disabled,
    error,
    fullWidth,
    ...
    color,
    variant
  }, other), label && React27.createElement(InputLabel_default, _extends({
    htmlFor: id,
    id: inputLabelId
  }, InputLabelProps), label), select ? React27.createElement(Select_default, _extends({
    "aria-describedby": helperTextId,
    id,
    labelId: inputLabelId,
    value,
    input: InputElement
  }, SelectProps), children) : InputElement, helperText && React27.createElement(FormHelperText_default, _extends({
    id: helperTextId
...
true ? TextField.propTypes = {
   ...
   * @deprecated Use `minRows` instead.
   */
  rows: deprecatedPropType(import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]), "Use `minRows` instead"),
  /**
   * Maximum number of rows to display.
   * @deprecated Use `maxRows` instead.
   */
  rowsMax: deprecatedPropType(import_prop_types23.default.oneOfType([import_prop_types23.default.number, import_prop_types23.default.string]), "Use `maxRows` instead"),
  /**
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-YP7WUXHO.js.map
