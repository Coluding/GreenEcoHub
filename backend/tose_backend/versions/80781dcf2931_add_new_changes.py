...
Revision ID: 80781dcf2931
Revises: 
Create Date: 2024-01-18 16:47:45.999867
...
def upgrade() -> None:
    ...
    sa.Column('arbeitgeber', sa.Boolean(), nullable=True),
    ...
    op.create_table('arbeitsverhältnis',
    sa.Column('arbeitsverhältnis_id', sa.Integer(), nullable=False),
    sa.Column('arbeitgeber_id', sa.Integer(), nullable=True),
    sa.Column('arbeitnehmer_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['arbeitgeber_id'], ['nutzer.user_id'], ),
    sa.ForeignKeyConstraint(['arbeitnehmer_id'], ['nutzer.user_id'], ),
    sa.PrimaryKeyConstraint('arbeitsverhältnis_id')
    )
    ...
    op.create_table('energieeffizienzmassnahmen',
    sa.Column('massnahmen_id', sa.Integer(), nullable=False),
    sa.Column('haushalt_id', sa.Integer(), nullable=True),
    sa.Column('massnahmetyp', sa.Enum('Isolierung', 'Heizungssystem', 'Fenstererneuerung', name='massnahmetyp'), nullable=True),
    sa.Column('einsparpotenzial', sa.Float(), nullable=True),
    sa.Column('kosten', sa.Float(), nullable=True),
    sa.ForeignKeyConstraint(['haushalt_id'], ['nutzer.user_id'], ),
    sa.PrimaryKeyConstraint('massnahmen_id')
    )
    ...
    sa.Column('ausweis_status', sa.Enum('AnfrageGestellt', 'ZusatzdatenEingegeben', 'Ausgestellt', name='ausweisstatus'), nullable=False),
    sa.ForeignKeyConstraint(['energieberater_id'], ['nutzer.user_id'], ),
    sa.ForeignKeyConstraint(['haushalt_id'], ['nutzer.user_id'], ),
    sa.ForeignKeyConstraint(['massnahmen_id'], ['energieeffizienzmassnahmen.massnahmen_id'], ),
    ...
    sa.Column('vertragsstatus', sa.Enum('Gekuendigt', 'Laufend', 'Gekuendigt_Unbestaetigt', name='vertragsstatus'), nullable=True),
    sa.ForeignKeyConstraint(['netzbetreiber_id'], ['nutzer.user_id'], ),
    ...
    op.create_table('kündigungsanfrage',
    sa.Column('anfrage_id', sa.Integer(), nullable=False),
    sa.Column('vertrag_id', sa.Integer(), nullable=True),
    sa.Column('bestätigt', sa.Boolean(), nullable=True),
    sa.ForeignKeyConstraint(['vertrag_id'], ['vertrag.vertrag_id'], ),
    ...
    sa.Column('energieausweis_id', sa.Integer(), nullable=True),
    ...
    sa.Column('prozess_status', sa.Enum('AnfrageGestellt', 'DatenAngefordert', 'DatenFreigegeben', 'AngebotGemacht', 'AngebotAngenommen', 'AngebotAbgelehnt', 'AusweisAngefordert', 'AusweisErstellt', 'PlanErstellt', 'Genehmigt', 'Abgenommen', 'InstallationAbgeschlossen', name='prozessstatus'), nullable=True),
    sa.Column('nvpruefung_status', sa.Boolean(), nullable=True),
    sa.Column('created_at', sa.TIMESTAMP(), server_default=sa.text('now()'), nullable=True),
    sa.ForeignKeyConstraint(['energieausweis_id'], ['energieausweise.energieausweis_id'], ),
    sa.ForeignKeyConstraint(['haushalt_id'], ['nutzer.user_id'], ),
    sa.ForeignKeyConstraint(['netzbetreiber_id'], ['nutzer.user_id'], ),
...
def downgrade() -> None:
    ...
    op.drop_table('kündigungsanfrage')
    ...
    op.drop_table('energieeffizienzmassnahmen')
    ...
    op.drop_table('arbeitsverhältnis')
